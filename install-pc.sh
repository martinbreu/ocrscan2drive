...
ExecStart=-/usr/bin/find /home/martinbreu/.google-drive/toOCR -name \"*.*\" -exec /bin/echo \"{}\" \; -exec /usr/bin/docker run --rm --user "$(id -u):$(id -g)" -v "/home/martinbreu/.google-drive/toOCR:/home/martinbreu/.google-drive/toOCR" -i jbarlow83/ocrmypdf:v11.1.1 -l eng+deu --rotate-pages --rotate-pages-threshold 2.5 --image-dpi 300 --force-ocr --jbig2-lossy --optimize 2 \"{}\" \"{}\" \;
ExecStart=-/usr/bin/find /home/martinbreu/.google-drive/toOCR -name \"*.*\" -exec /bin/echo \"{}\" \; -exec /usr/bin/docker run --rm --user "$(id -u):$(id -g)" -v "/home/martinbreu/.google-drive/toOCR:/home/martinbreu/.google-drive/toOCR" -i jbarlow83/ocrmypdf:v11.1.1 -l eng+deu --deskew --rotate-pages-threshold 2.5 --image-dpi 300 --force-ocr --jbig2-lossy --optimize 2 \"{}\" \"{}.pdf\" \; -exec /bin/rm \"{}\" \;
